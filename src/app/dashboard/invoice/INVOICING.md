...
**Item fields:** description, productId (optional), quantity, unit (default pieces), unitPrice, totalAmount (optional), priceType (optional, e.g. `"wholesale"`, `"retail"`, or `"custom"` – which price was used for the customer).
