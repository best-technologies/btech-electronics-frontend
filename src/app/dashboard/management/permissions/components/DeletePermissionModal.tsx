            ...
            >
              <div className="flex items-start gap-4 p-6">
                ...
                <div className="flex-1 min-w-0">
                  <h2 id="delete-permission-title" className="text-lg font-semibold text-foreground">
                    Delete permission?
                  </h2>
                  <p id="delete-permission-description" className="mt-1 text-sm text-muted-foreground">
                    <span className="font-medium text-foreground">{permission.displayName || permission.name}</span>
                    {" "}({permission.name}) will be permanently removed and revoked from all users. This cannot be undone.
                  </p>
                </div>
                <Button
                  variant="ghost"
